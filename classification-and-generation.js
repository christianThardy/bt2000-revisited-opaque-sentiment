      ...
      async function generateText(classification) {
        ...
        const response = await openai.textGeneration.create({
          ...
          prompt: `I want you to act as a mental health assistant that can have meaningful conversations. 
                   ...
                   sentiment is detected. If the sentiment is assess_further, use your wit, creativity, and 
                   observational skills to have a conversaion. Ask the user questions and mimic their sentiment 
                   until a positive or negative sentiment is detected based on the classification input from each 
                   response. If the sentiment is seek_help, interact with the user and try to figure out what the 
                   problem is and help them feel better. The sentiment of the transcription is ${classification}.`,
